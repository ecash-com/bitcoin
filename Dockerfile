...
# Build the project. JOBS caps parallelism when building next to a live
# node whose dbcache already owns most of the RAM.
ARG JOBS
RUN cmake --build build -j"${JOBS:-$(nproc)}"
...
EXPOSE 8533 18533 18644

# RPC interface (mainnet, testnet & regnet respectively)
EXPOSE 8532 18532 18643
