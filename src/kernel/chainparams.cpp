...
public:
    CMainParams() {
        ...
        consensus.EcashHeight = 963648; // Retarget boundary, 2016 * 478
        ...
        // Each resolves to a node, which we fall back to using as
        // an addrfetch connection to learn the rest of the network from.
        vSeeds.emplace_back("seed.alpha.ecash.ninja.");
        vSeeds.emplace_back("seed.alpha.bip300.xyz.");
        vSeeds.emplace_back("seed.alpha.ecash.drivecha.in.");
        vSeeds.emplace_back("seed.alpha.ecash.zuexeuz.net.");
        ...
        vFixedSeeds.clear(); //!< No fixed seeds yet. Bootstrap via vSeeds above.
        ...
        m_assumeutxo_data = {
            ...
            {
                .height = 963'648,
                .hash_serialized = AssumeutxoHash{uint256{"9dcc897da984d93eda56e5c4d0c4d6b54e75df7d03f5c8ae1459f511fadf7210"}},
                .m_chain_tx_count = 1423154850,
                .blockhash = uint256{"0000000000b360c17636b7a6c366e3effbe91a847eb5d61b7a7b29476439e924"},
            }
        };
